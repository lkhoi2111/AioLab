...
export const config = {
  ...
  uploadDir: 'D:/AI-Music-Studio/uploads',
  resultDir: 'D:/AI-Music-Studio/results',
  separatedDir: 'D:/AI-Music-Studio/separated',
  ...
  ffmpegLocation:
    process.env.FFMPEG_LOCATION || path.join(rootDir, 'ffmpeg-8.1.1-essentials_build', 'bin'),
